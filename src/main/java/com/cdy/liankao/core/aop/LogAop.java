...
import com.cdy.liankao.core.log.LogManager;
import com.cdy.liankao.core.log.LogObjectHolder;
import com.cdy.liankao.core.log.factory.LogTaskFactory;
import com.cdy.liankao.core.shiro.ShiroKit;
import com.cdy.liankao.core.shiro.ShiroUser;
import com.cdy.liankao.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.cdy.liankao.core.common.annotion.BussinessLog)")
